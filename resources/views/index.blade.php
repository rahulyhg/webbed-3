...
<div class="banner wow bounceInRight" data-wow-delay="0.4s">
	<div class="container"> 
	   <div class="banner_right">
		   <h2>Love in College</h2>
		   <h1>Your dream date at NITT</h1>
		   <ul class="button">
			 <li><a href="/register" class="btn1 btn2 btn-1 btn1-1b">Get Started</a></li>
		   </ul>
	   </div>
	</div>
</div>
					...
					<ul class="slides">
						<li>
							<div class="banner-info">
							   <h3>Meet Adam and Eve</h3>
							   <h4><span class="m_2">"</span> she is the only thing I love more than StaffC coffee<span class="m_2"> "</span></h4>
							   ...
							   <h5><a href="#">Adam Sankaran ,</a>Louuer since 2016</h5>
							</div>
						</li>
				    </ul>
				 </div>
